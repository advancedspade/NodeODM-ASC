...
app.post('/gcs/upload/:uploadId/recover', authCheck, jsonBodyParser, gcsUploadApi.handleRecover);
app.get('/gcs/upload/:uploadId/progress', authCheck, gcsUploadApi.assignUploadProgress, gcsUploadApi.handleProgress);
